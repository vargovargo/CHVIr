...
jscode <- "Shiny.addCustomMessageHandler('mymessage', function(message) {window.top.location.href = 'https://discovery.cdph.ca.gov/ohe/CCHVIz/';});"

ui <- fluidPage(
  tags$head(tags$script(jscode)),   
  HTML("<h3 align='center'>The CCHVIz beta site has moved!</h3>"),
  HTML("<h3 align='center'>You will be redirected in 5 seconds</h3>"),
  br(),
  HTML("<h3 align='center'>If you have not been redirected, use the following link:</h3>"),
  HTML("<a href='https://discovery.cdph.ca.gov/ohe/CCHVIz/'><h3 align='center'>discovery.cdph.ca.gov/ohe/CCHVIz/</h3></a>")
)
